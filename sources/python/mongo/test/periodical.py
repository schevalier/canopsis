...
"""PeriodicalStorage UTs."""

from unittest import TestCase, main

from canopsis.mongo.timed import MongoPeriodicalStorage
from canopsis.timeserie.timewindow import TimeWindow


class PeriodicalStorageTest(TestCase):
    """MongoPeriodicalStorage UT on data_type = "test_store"""

    def setUp(self):
        # create a storage on test_store collections
        self.storage = MongoPeriodicalStorage(data_scope="test_store")
